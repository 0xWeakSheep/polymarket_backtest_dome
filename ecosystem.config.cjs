module.exports = {
  apps: [
    ...
    {
      name: "btc-15m-theoretical-universe",
      cwd: "/Users/caoxiangrui/Desktop/external/polymarket_backtest",
      script: "./scripts/run_btc_15m_theoretical_universe.sh",
      interpreter: "bash",
      autorestart: false,
      max_restarts: 20,
      restart_delay: 5000,
      ...
      time: true,
      merge_logs: true,
      out_file: "./logs/btc_15m_theoretical_universe.out.log",
      error_file: "./logs/btc_15m_theoretical_universe.err.log",
      env: {
        PYTHONUNBUFFERED: "1",
      },
    },
    {
      name: "btc-15m-theoretical-trades",
      cwd: "/Users/caoxiangrui/Desktop/external/polymarket_backtest",
      script: "./scripts/run_btc_15m_theoretical_trades.sh",
      interpreter: "bash",
      autorestart: false,
      max_restarts: 20,
      restart_delay: 5000,
      ...
      time: true,
      merge_logs: true,
      out_file: "./logs/btc_15m_theoretical_trades.out.log",
      error_file: "./logs/btc_15m_theoretical_trades.err.log",
      env: {
        PYTHONUNBUFFERED: "1",
      },
    },
